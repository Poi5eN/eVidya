...
function AdmissionForm({ onClose }) {
    ...
    const handleSaveClick = async () => {
        setLoading(true);
        try {
           console.log("anand Student data",student)
            const studentData = {
                schoolId: schoolID,
                studentFullName: student?.name,
                studentEmail:  `${student.name}${student.contact}@gmail.com`, // Add these fields as needed
                parentEmail:  `${student.fatherName}${student.contact}@gmail.com`, // Add these fields as needed
                studentPassword: student?.contact,
                parentPassword: student?.contact,
    ...
    return (
        <>
           ...
           <button
                        className="w-full bg-green-500 text-white py-2 rounded-md mb-5"
...
//         try {
//             const croppedImageUrl = await getCroppedImg(croppedImageSource, croppedAreaPixels);
//             setStudent(prev => ({ ...prev, photo: croppedImageUrl }));
//             setCroppedImageSource(null);
//         } catch (error) {
//             console.error("Error cropping image:", error);
//         }
...
//                 schoolId: schoolID,
//                 studentFullName: student.name,
//                 studentEmail: "", // Add these fields as needed
//                 studentPassword: "",
//                 studentDateOfBirth: student.dob,
//                 studentGender: "",
//                 studentClass: student.class,
