...
function Additional_Fees_DataTable({ data, handleDelete, handleEdit }) { // Receive handleEdit
  ...
  const columns = [
    ...
    { field: "amount", headerName: "Amount", flex: 1 },
    {
      ...
      renderCell: (params) => (
        <div>
          {/* Remove the Link and use the handleEdit prop directly */}
          <IconButton onClick={() => handleEdit(params.row)}> {/* Call handleEdit with the row data */}
