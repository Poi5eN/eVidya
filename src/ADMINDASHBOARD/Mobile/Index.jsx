...
import {  FaBook, FaStar, FaFileAlt, FaMoneyBillAlt } from "react-icons/fa";
import { MdOutlineAssignment } from "react-icons/md";
import { IoMdApps } from "react-icons/io";


import { FiUser } from 'react-icons/fi';
import {  MdLibraryAdd, MdSchool, MdPlaylistAdd, MdOutlinePeopleAlt, MdOutlinePersonAdd, MdOutlineSettings, MdOutlineAccountBalance } from 'react-icons/md';
import { BsReceipt } from 'react-icons/bs';
import { RiParentFill } from 'react-icons/ri';
import { GrCatalog } from 'react-icons/gr';
import { SiUdacity } from 'react-icons/si'; // Changed from SiUdise to SiUdacity
...
import NewCheckFee2 from "../Fees/NewCheckFee2";
import Primary from "../Classes/Primary/Primary";
...
const Mobile = () => {
    ...
    const menuItems = [
         {
            title: "Registration",
            icon: <MdOutlinePersonAdd className="text-5xl mb-1" />,
            iconType: "component",
            colors: { text: "text-green-600", hoverBg: "hover:bg-green-50" },
        },
        {
            title: "Admission",
            icon: <MdOutlinePeopleAlt className="text-5xl mb-1" />,
             iconType: "component",
            colors: { text: "text-blue-600", hoverBg: "hover:bg-blue-50" },
        },
        {
            title: "Student",
            icon: <MdSchool className="text-5xl mb-1" />,
             iconType: "component",
            colors: { text: "text-red-600", hoverBg: "hover:bg-red-50" },
        },
       {
            title: "Fees",
            icon: <BsReceipt className="text-5xl mb-1" />,
             iconType: "component",
        ...
        {
            title: "Classes",
            icon: <MdPlaylistAdd className="text-5xl mb-1" />,
            iconType: "component",
            colors: { text: "text-indigo-600", hoverBg: "hover:bg-indigo-50" },
        },
         {
            title: "Teachers",
           icon: <FiUser className="text-5xl mb-1" />,
            iconType: "component",
            colors: { text: "text-pink-600", hoverBg: "hover:bg-pink-50" },
        },
        {
            title: "Parents",
            icon: <RiParentFill className="text-5xl mb-1" />,
        ...
        {
            title: "Account",
            icon: <MdOutlineAccountBalance className="text-5xl mb-1" />,
             iconType: "component",
            colors: { text: "text-orange-600", hoverBg: "hover:bg-orange-50" },
        },
        {
            title: "Inventory",
            icon: <GrCatalog className="text-5xl mb-1" />,
        ...
        {
            title: "Library",
            icon: <MdLibraryAdd className="text-5xl mb-1" />,
        ...
        {
            title: "Certificate",
            icon: <LuBadgePercent className="text-5xl mb-1" />,
             iconType: "component",
             colors: { text: "text-red-600", hoverBg: "hover:bg-red-50" },
        },
        {
            title: "ID Card",
            icon: <TbId className="text-5xl mb-1" />,
            iconType: "component",
            colors: { text: "text-purple-600", hoverBg: "hover:bg-purple-50" },
        },
          {
            title: "Udise",
            icon: <SiUdacity className="text-5xl mb-1" />, // Corrected icon
            iconType: "component",
            colors: { text: "text-teal-600", hoverBg: "hover:bg-teal-50" },
        },
        {
       ...
       
        {
         ...
         {
             title: "Promotion",
           icon: <MdOutlineSettings className="text-5xl mb-1" />,
             iconType: "component",
            colors: { text: "text-lime-600", hoverBg: "hover:bg-lime-50" },
        },
    ...
    const renderActiveComponent = () => {
        switch (activeComponent) {
            case "Registration":
                return <Newegistrations/>; // Replace with your Registration component
            case "Admission":
                return <Create_Registration_Form/>; // Replace with your Admission component
            case "Student":
                return <Allstudent />;
            case "Fees":
                 return <Fees/>; // Replace with your Set Fees component
            case "Fees Payment":
                 return <NewCheckFee2/>; // Replace with your Fees Payment component
            case "Classes":
                return <Primary/>; // Replace with your Classes component
             case "Teachers":
                 return <AllTeachers/>; // Replace with your Teachers component
            case "Parents":
                return <CreateParents/>; // Replace with your Parents component
           case "Account":
                 return <div>Account Component Here</div>; // Replace with your Account component
           case "Inventory":
                 return <div>Inventory Component Here</div>; // Replace with your Inventory component
           case "Library":
                 return <div>Library Component Here</div>; // Replace with your Library component
           case "Employee":
                 return <div>Employee Component Here</div>; // Replace with your Employee component
           case "Results":
                  return <div>Results Component Here</div>; // Replace with your Results component
           case "Curriculum":
                  return <div>Curriculum Component Here</div>; // Replace with your Curriculum component
           case "Certificate":
                return <div>Certificate Component Here</div>; // Replace with your Certificate component
           case "ID Card":
                return <div>ID Card Component Here</div>; // Replace with your ID Card component
           case "Udise":
                return <div>Udise Component Here</div>; // Replace with your Udise component
           case "Admit Card":
                return <div>Admit Card Component Here</div>; // Replace with your Admit Card component
           case "All Form":
                  return <div>All Form Component Here</div>; // Replace with your All Form component
           case "Promotion":
                  return <div>Promotion Component Here</div>; // Replace with your Promotion component
