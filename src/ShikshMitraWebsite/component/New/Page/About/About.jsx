  ...
  return (
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid items-center grid-cols-1 md:grid-cols-2">
            ...
            <div>
                <h2 class="text-3xl font-bold leading-tight text-[#2fa7db] dark:text-white sm:text-4xl lg:text-5xl">Hey 👋 I
                    am
                    <br class="block sm:hidden" /> Digital Vidya <span className='text-[#ee582c]'> Saarthi </span> ERP
                </h2>
                <p class="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 dark:text-gray-300 md:mt-8">
                Digital Vidya Saarthi is a powerful ERP software designed to streamline school management. It simplifies student records, fee collection, attendance tracking, and communication. With a user-friendly interface and advanced automation, it enhances efficiency, reduces paperwork, and ensures seamless coordination between administrators, teachers, students, and parents.
                </p>
