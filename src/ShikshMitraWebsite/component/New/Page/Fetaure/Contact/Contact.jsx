...
const Contact = () => {
  return (
    ...
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12 py-4">
                <p class="text-base font-semibold uppercase tracking-wide text-blue-600 dark:text-blue-200 ">
                    {/* Contact */}
                </p>
                <h2
                    class="font-heading mb-4 font-bold tracking-tight text-[#2fa7db] dark:text-white text-3xl sm:text-5xl">
        ...
        <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                    ...
                    Have questions or need assistance? Contact us for any inquiries regarding Digital Vidya Saarthi ERP. Our team is ready to support you with expert guidance and solutions. Reach out via phone, email, or our online form, and we’ll ensure a prompt and helpful response.
                    </p>
                    <ul class="mb-6 md:mb-0">
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-[#ee582c] text-gray-50">
                ...
                <div class="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <form id="contactForm">
                        ...
                        <div class="text-center">
                            <button type="submit" class="w-full bg-[#ee582c] text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
