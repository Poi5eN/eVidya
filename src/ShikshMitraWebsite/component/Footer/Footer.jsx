...
const Footer = () => {
  return (
    <div  className="bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white">
    
      
       <div class="bg-black/5 p-4 text-center text-xl">
       Copyright © 2025  
    <a href="https://edaksha.netlify.app/"> DIGITALVIDYASAARTHI</a>
